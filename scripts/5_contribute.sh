...
# contribute
cleos transfer $CONTRIBUTOR aikonworbli1 "$AMOUNT" "$ORIGIN,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CONTRIBUTOR
cleos transfer $CUSTODIAN_ACCOUNT aikonworbli1 "$AMOUNT" "$ORIGIN,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CUSTODIAN_ACCOUNT
