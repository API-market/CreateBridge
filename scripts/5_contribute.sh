...
# contribute
cleos transfer $CONTRIBUTOR oreorebridge "$AMOUNT" "$ORIGIN,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CONTRIBUTOR
cleos transfer $CUSTODIAN_ACCOUNT oreorebridge "$AMOUNT" "$ORIGIN,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CUSTODIAN_ACCOUNT
